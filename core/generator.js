...
module.exports = {
  ...
  generate: function(projecttype, projectname) {
    if (
      ...
      (!projecttype == "" && !projectname == undefined) ||
      !projectname == ""
    ) {
            ...
            fs.writeFile(
              ...
              function(err) {
                ...
                // We now know that evrything is smooth
                  ...
                  fs.copy(
                    fixedurl + "/templates/angularsimple/",
                    "./" + projectname + "",
                    function(err) {
                      if (err) {
                        console.error(err);
                        ...
                        console.log(
                          "Your AngularSimple App Is up And Running on http://localhost:5000"
                        );
                      }
                    }
                  );
